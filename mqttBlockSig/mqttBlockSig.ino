...
//      IotWebConf        v2.3.1  by Balazs Kelemen      - https://github.com/prampec/IotWebConf
...
//      ArduinoJson       v6.15.1 by Benoit Blanchon     - https://github.com/bblanchon/ArduinoJson
//
//    This code is realising a block signal module for single track.
//    The signal module has one IR modules for block detection.
//    The signal module also has two signals, one in each direction. The signal supported
//    are from two lights (Hsi2) up to five lights (Hsi5) signals or two-three lights
...
//
//    The signal acts on the two surrounding block signal modules, one upwards (forward) and one downwards (backward).
//
// ------------------------------------------------------------------------------------------------------------------------------
// Include all libraries
#include <ArduinoHttpClient.h>                    // Library to handle HTTP download of config file
#include <ArduinoJson.h>                          // Library to handle JSON
